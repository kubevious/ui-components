...
export const ConfirmationDialog: FC = () => {
    ...
    const sharedState = useSharedState((sharedState) => {
        sharedState.subscribe(CONFIRMATION_DIALOG_PARAMS_SHARED_KEY, (value) => {
            setParams(value);
        });
    });
    ...
    return <>{params && <ConfirmationDialogComponent params={params!} onCancel={onCancel} onConfirm={onConfirm} />}</>;
};
